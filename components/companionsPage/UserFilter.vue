<template>
  <form class="filter">
    ...
    <fieldset class="filter__field field">
      ...
      <ul>
        <li>
          <input id="vacation" type="radio">
          <label for="vacation">Отдых</label>
        </li>
        <li>
          <input id="work" type="radio">
          <label for="work">Работа</label>
        </li>
        <li>
          <input id="study" type="radio">
    ...
    <fieldset class="filter__field field">
      ...
      <ul>
        ...
        <li>
          <input id="techno" type="checkbox">
          <label for="techno">Техно</label>
        </li>
        <li>
        ...
        <li>
          <input id="juzz" type="checkbox">
          <label for="juzz">Джаз</label>
        </li>
      </ul>
    </fieldset>
    <fieldset class="filter__field field">
      ...
      <ul>
        <li>
          <label for="plane">
            <svg :opacity="true" id="icon-plane" width="16" height="16" viewBox="0 0 21 23" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <input id="plane" type="radio">
        </li>
        <li>
          <label for="auto">
            <svg :opacity="true" id="icon-auto" width="16" height="16" viewBox="0 0 18 21" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <li>
          <label for="bike">
            <svg :opacity="true" id="icon-bike" width="16" height="16" viewBox="0 0 25 24" fill="none"  xmlns="http://www.w3.org/2000/svg">
          ...
          <input id="bike" type="radio">
        </li>
        <li>
          <label for="walk">
            <svg :opacity="true" id="icon-walk" width="16" height="16" viewBox="0 0 21 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const rangeBarStyle = computed(() => {
  return {
    left: `${level.min / range.max * 100}%`,
    right: `${100 - (level.max / range.max * 100)}%`,
  };
});

const onMinLevelChange = ({target}) => {
  level.min = parseInt(target.value);
  
  if (level.min >= level.max) {
    level.min = level.max - range.step;
  }
};

const onMaxLevelChange = ({target}) => {
  level.max = parseInt(target.value);

  if (level.max <= level.min) {
    level.max = level.min + range.step;
  }
};
</script>
