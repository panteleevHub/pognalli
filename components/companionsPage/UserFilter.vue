<template>
  <form @submit.prevent="console.log(selectedData)" class="filter">
    ...
    <fieldset class="filter__field field">
      <legend class="field__caption">Цель поездки<span>:</span></legend>
      <ul>
    ...
    <fieldset class="filter__field field">
      <legend class="field__caption">Музыка<span>:</span></legend>
      <ul>
    ...
    <fieldset class="filter__field field">
      <legend class="field__caption">Транспорт<span>:</span></legend>
      <ul>
        <li>
          <label for="plane">
    ...
    <fieldset class="filter__field field">
      <legend class="field__caption">Возраст<span>:</span></legend>
      <input v-model="selectedData.age" type="number">
    </fieldset>
    <fieldset class="filter__field field field--level">
      <legend class="field__caption">Левел<span>:</span></legend>
