        ...
        <ul class="companions__list">
          <li v-for="{name, avatar, countries, tags, transport, level} in companions" class="companions__item">
            ...
            <div class="companions__user-info">
              <p class="companions__user-name">{{ name }}</p>
              <p class="companions__tags">{{ tags.join(' ') }}</p>
              <ul class="companions__transport-list">
                <li class="companions__transport-item">
                  <svg :opacity="transport.includes('plane') ? 1 : 0.15" id="icon-plane" width="21" height="23" viewBox="0 0 21 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="companions__transport-item">
                  <svg :opacity="transport.includes('bus') ? 1 : 0.15" id="icon-bus" width="18" height="21" viewBox="0 0 18 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="companions__transport-item">
                  <svg :opacity="transport.includes('bike') ? 1 : 0.15" id="icon-bike" width="25" height="24" viewBox="0 0 25 24" fill="none"  xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="companions__transport-item">
                  <svg :opacity="transport.includes('walk') ? 1 : 0.15" id="icon-walk" width="21" height="24" viewBox="0 0 21 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
.companions__transport-item svg {
  display: block;
}

.companions__transport-item:last-child {
  margin-left: -3px;
}
